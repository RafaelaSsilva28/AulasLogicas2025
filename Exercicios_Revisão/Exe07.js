...
let hora = (prompt('Digite quanto voce ganha por hora: '));
let num = (prompt('Digite o numero de hora que voce trabalha no mes: '));
let bruto = hora*num;
let IR = (11/100)*bruto;
let  INSS = (8/100)*bruto;
let sindicato = (5/100)*bruto;
let descontos = IR + INSS + sindicato;
let liquido = descontos - bruto;
console.log('O salario bruto é', bruto, 'paguei no INSS', INSS, 'e de imposto de renda', IR, 'ja o meu salario liquido é de', liquido)